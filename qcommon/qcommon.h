...
#ifdef IOCTRL
void		CM_WritePortalState (int f);
void		CM_ReadPortalState (int f);
#else
...
void *Z_G_Malloc (int size); 			// for game clearing
void *Z_G_TagMalloc (int size, int tag); // for game clearing
