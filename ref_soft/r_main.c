...
void R_RenderFrame (refdef_t *fd)
{
	...
	//printf("R_RenderFrame begin\n");

	R_SetupFrame ();

  //printf("R_RenderFrame begin: R_SetupFrame\n");

	R_MarkLeaves ();	// done here so we know if we're in water

  //printf("R_RenderFrame begin: R_MarkLeaves\n");

	R_PushDlights (r_worldmodel);

  //printf("R_RenderFrame begin: R_PushDlights\n");

	R_EdgeDrawing ();

  //printf("R_RenderFrame begin: R_EdgeDrawing\n");
  ...
  //printf("R_RenderFrame begin: R_DrawEntitiesOnList\n");
  ...
  //printf("R_RenderFrame begin: R_DrawParticles\n");
...
PSP_MODULE_INFO("q2librefsoft", 0x1000, 1, 1);
