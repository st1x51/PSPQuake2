...
#ifdef IOCTRL
	FS_Fwrite (&swlen, 4, 1, cls.demofile);
	FS_Fwrite (net_message.data+8,	len, 1, cls.demofile);
#else
...
// finish up
	len = -1;
#ifdef IOCTRL
	FS_Fwrite (&len, 4, 1, cls.demofile);
...
#ifdef IOCTRL
				FS_Fwrite (&len, 4, 1, cls.demofile);
				FS_Fwrite (buf.data, buf.cursize, 1, cls.demofile);
#else
                fwrite (&len, 4, 1, cls.demofile);
...
//Crow_bar. debug clear
/*
	memset(cl.model_draw,     0, sizeof(cl.model_draw));
    memset(cl.model_clip,     0, sizeof(cl.model_clip));
    memset(cl.sound_precache, 0, sizeof(cl.sound_precache));
    memset(cl.image_precache, 0, sizeof(cl.image_precache));
*/
